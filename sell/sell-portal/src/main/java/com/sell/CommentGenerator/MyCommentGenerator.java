package com.sell.CommentGenerator;
...
public class MyCommentGenerator implements CommentGenerator{
    ...
    */
	 ...
	 *@Description: 从该配置中的任何属�?�添加此实例的属性CommentGenerator配置�?
	 *              这个方法将在任何其他方法之前被调用�??
	 *@Author fendo
	 *@Date 2017�?10�?5�? 下午3:45:58
	 *@return
	 *@throws
	 */
	@Override
    ...
    */
	...
	/**
	 * 普�?�方法的注释，这里主要是XXXMapper.java里面的接口方法的注释
	 */
	@Override
